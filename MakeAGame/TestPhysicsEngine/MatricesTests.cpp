...
{
	TEST_CLASS(MatrixTester)
	{

		TEST_METHOD(T_001_defaultConstructor)
		{
			Matrix a(3, 3);
		...
		TEST_METHOD(T_002_copyConstructor)
		{
			Matrix a(3, 3);
		...
		TEST_METHOD(T_003_moveConstructor)
		{
		...
		TEST_METHOD(T_004_assignmentOperator)
		{
			//make a 3X3 matrix with those values
			Matrix a(3, 3);
		...
		TEST_METHOD(T_005_moveAssignmentOperator)
		{
			//make a 3X3 matrix with those values
			Matrix a(3, 3);
		...
		TEST_METHOD(T_006_accessOperator)
		{
			//make a 3X3 matrix with those values
			Matrix a(3, 3);
		...
		TEST_METHOD(T_009_multiplicationOperator)
		{
			//make a 3X3 matrix with those values
			Matrix a(3, 3);
		...
		TEST_METHOD(T_010_additionOperator)
		{
			//make a 3X3 matrix with those values
			Matrix a(3, 3);
		...
		TEST_METHOD(T_011_subtractionOperator)
		{
			//make a 3X3 matrix with those values
			Matrix a(3, 3);
		...
		TEST_METHOD(T_013_outputoperator)
		{
			Matrix a(3, 3);
