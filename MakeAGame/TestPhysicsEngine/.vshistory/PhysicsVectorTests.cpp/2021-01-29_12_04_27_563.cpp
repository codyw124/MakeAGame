...
{
	TEST_CLASS(PhysicsVectorTester)
	{
		...
		TEST_METHOD(T_064_getAndAddDimensions)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(6);
		...
		TEST_METHOD(T_067_multiplyMatrix)
		{
			PhysicsVector a;
			a.addDimension(1);
			a.addDimension(2);
		...
		TEST_METHOD(T_068_multiplyMatrixShorthand)
		{
			PhysicsVector a;
			a.addDimension(1);
			a.addDimension(2);
