...
void PhysicsVectorTests::rotate3D()
{
	...
	Assert::IsTrue(rotatedRightY[0] == 4.4408920985006262e-16, L"rotate3D Y");
	Assert::IsTrue(rotatedRightY[1] == 5, L"rotate3D Y");
	Assert::IsTrue(rotatedRightY[2] == 7.0710678118654755, L"rotate3D Y");

	PhysicsVector rotatedLeftY = test.rotate3D(-45.0, PhysicsVector::Y);
	Assert::IsTrue(rotatedLeftY[0] == 7.0710678118654755, L"rotate3D Y");
	Assert::IsTrue(rotatedLeftY[1] == 5, L"rotate3D Y");
	Assert::IsTrue(rotatedLeftY[2] == 4.4408920985006262e-16, L"rotate3D Y");
}
