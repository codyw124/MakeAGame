...
void PhysicsVectorTests::rotate3D()
{
	...
	double x = rotatedRightZ[0];
	double y = rotatedRightZ[1];
	double z = rotatedRightZ[2];
	...
	double x = rotatedLeftZ[0];
	double y = rotatedLeftZ[1];
	double z = rotatedLeftZ[2];
	Assert::IsTrue(rotatedLeftZ[0] == 4.4408920985006262e-16, L"rotate3D");
	Assert::IsTrue(rotatedLeftZ[1] == 7.0710678118654755, L"rotate3D");
