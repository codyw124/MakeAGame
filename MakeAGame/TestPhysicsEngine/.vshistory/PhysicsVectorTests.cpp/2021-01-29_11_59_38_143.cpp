...
namespace PhysicsEngineTester
{
	TEST_CLASS(PhysicsVectorTester)
	{
		...
		TEST_METHOD(T_001_constructorWithValues2D)
		{
			double* values = new double[2];
			values[0] = 5.5;
			values[1] = 7.1;
		...
		TEST_METHOD(T_002_copyConstructor2D)
		{
			double* values = new double[2];
			values[0] = 5.5;
			values[1] = 7.1;
		...
		TEST_METHOD(T_003_moveConstructor2D)
		{
			double* values = new double[2];
			values[0] = 5.0;
			values[1] = 6.0;
		...
		TEST_METHOD(T_004_assignmentOperator2D)
		{
			double* values = new double[2];
			values[0] = 55;
			values[1] = 10;
		...
		TEST_METHOD(T_005_moveAssignmentOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 6;
		...
		TEST_METHOD(T_006_additionOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_007_subtractionOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_008_multiplyOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_009_multiplyByDoubleOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_010_equivalenceOperators2D)
		{
			double* values = new double[2];
			values[0] = 50;
			values[1] = 70;
		...
		TEST_METHOD(T_011_dotProduct2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_013_magnitudeSquared2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_014_divideOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_015_divideByDoubleOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_016_additionShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_017_subtractionShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_017_multiplyShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_018_multiplyByDoubleShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_019_divideShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_020_divideByDoubleShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_022_distanceSquared2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_024_normalized2D)
		{
		...
		TEST_METHOD(T_026_outputOperator2D)
		{
			PhysicsVector test = PhysicsVector();
		...
		TEST_METHOD(T_027_perpendicular2D)
		{
			PhysicsVector first = PhysicsVector();
			first.addDimension(5);
			first.addDimension(5);
		...
		TEST_METHOD(T_031_constructor3D)
		{
			PhysicsVector test;
			test.addDimension(0);
			test.addDimension(0);
		...
		TEST_METHOD(T_032_constructorWithValues3D)
		{
			PhysicsVector test;
		...
		TEST_METHOD(T_033_copyConstructor3D)
		{
			PhysicsVector test;
			test.addDimension(5.5);
			test.addDimension(7.1);
		...
		TEST_METHOD(T_034_moveConstructor3D)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(6);
		...
		TEST_METHOD(T_035_assignmentOperator3D)
		{
			PhysicsVector test;
			test.addDimension(55);
			test.addDimension(10);
		...
		TEST_METHOD(T_036_moveAssignmentOperator3D)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(6);
		...
		TEST_METHOD(T_037_additionOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
		...
		TEST_METHOD(T_038_subtractionOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_039_multiplyOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_040_multiplyByDoubleOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_041_equivalenceOperators3D)
		{
			PhysicsVector test;
		...
		TEST_METHOD(T_042_dotProduct3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_044_magnitudeSquared3D)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(10);
		...
		TEST_METHOD(T_045_divideOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_046_divideByDoubleOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_047_additionShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_048_subtractionShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_049_multiplyShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_050_multiplyByDoubleShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_051_divideShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_052_divideByDoubleShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_054_distanceSquared3D)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(10);
		...
		TEST_METHOD(T_056_normalized3D)
		{
			PhysicsVector test;
			test.addDimension(0);
			test.addDimension(10);
		...
		TEST_METHOD(T_058_outputOperator3D)
		{
			PhysicsVector test;
			test.addDimension(55);
			test.addDimension(703);
		...
		TEST_METHOD(T_059_perpendicular3D)
		{
			PhysicsVector first;
			first.addDimension(5);
			first.addDimension(5);
		...
		TEST_METHOD(T_062_crossProduct3D)
		{
			PhysicsVector right;
		...
		TEST_METHOD(T_063_accessOperator)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(6);
		...
		TEST_METHOD(T_000_multiplyMatrix)
		{
			PhysicsVector a;
			a.addDimension(1);
			a.addDimension(2);
		...
		TEST_METHOD(T_000_multiplyMatrixShorthand)
		{
			PhysicsVector a;
			a.addDimension(1);
			a.addDimension(2);
