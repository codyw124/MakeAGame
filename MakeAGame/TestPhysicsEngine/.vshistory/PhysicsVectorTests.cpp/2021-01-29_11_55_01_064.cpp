...
namespace PhysicsEngineTester
{
	TEST_CLASS(PhysicsVectorTester)
	{
		...
		TEST_METHOD(T_000_magnitudeSquared2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_000_divideOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_000_divideByDoubleOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_000_additionShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_000_subtractionShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_000_multiplyShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_000_multiplyByDoubleShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_000_divideShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_000_divideByDoubleShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_000_distanceSquared2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_000_normalized2D)
		{
		...
		TEST_METHOD(T_000_outputOperator2D)
		{
			PhysicsVector test = PhysicsVector();
		...
		TEST_METHOD(T_000_perpendicular2D)
		{
			PhysicsVector first = PhysicsVector();
			first.addDimension(5);
			first.addDimension(5);
		...
		TEST_METHOD(T_000_constructor3D)
		{
			PhysicsVector test;
			test.addDimension(0);
			test.addDimension(0);
		...
		TEST_METHOD(T_000_constructorWithValues3D)
		{
			PhysicsVector test;
		...
		TEST_METHOD(T_000_copyConstructor3D)
		{
			PhysicsVector test;
			test.addDimension(5.5);
			test.addDimension(7.1);
		...
		TEST_METHOD(T_000_moveConstructor3D)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(6);
		...
		TEST_METHOD(T_000_assignmentOperator3D)
		{
			PhysicsVector test;
			test.addDimension(55);
			test.addDimension(10);
		...
		TEST_METHOD(T_000_moveAssignmentOperator3D)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(6);
		...
		TEST_METHOD(T_000_additionOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
		...
		TEST_METHOD(T_000_subtractionOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_multiplyOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_multiplyByDoubleOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_equivalenceOperators3D)
		{
			PhysicsVector test;
		...
		TEST_METHOD(T_000_dotProduct3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_magnitudeSquared3D)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(10);
		...
		TEST_METHOD(T_000_divideOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_divideByDoubleOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_additionShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_subtractionShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_multiplyShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_multiplyByDoubleShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_divideShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_divideByDoubleShorthandOperator3D)
		{
			PhysicsVector orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_000_distanceSquared3D)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(10);
		...
		TEST_METHOD(T_000_normalized3D)
		{
			PhysicsVector test;
			test.addDimension(0);
			test.addDimension(10);
		...
		TEST_METHOD(T_000_outputOperator3D)
		{
			PhysicsVector test;
			test.addDimension(55);
			test.addDimension(703);
		...
		TEST_METHOD(T_000_perpendicular3D)
		{
			PhysicsVector first;
			first.addDimension(5);
			first.addDimension(5);
		...
		TEST_METHOD(T_000_crossProduct3D)
		{
			PhysicsVector right;
		...
		TEST_METHOD(T_000_accessOperator)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(6);
		...
		TEST_METHOD(T_000_getAndAddDimensions)
		{
			PhysicsVector test;
			test.addDimension(5);
			test.addDimension(6);
