...
void PhysicsVectorTests::rotate3D()
{
	...
	PhysicsVector rotatedRight = test.rotate3D(-45.0, PhysicsVector::Z);
	double x = rotatedRight[0];
	double y = rotatedRight[1];
	double z = rotatedRight[2];
	Assert::IsTrue(rotatedRight[0] == 7.0710678118654755, L"rotate3D");
	Assert::IsTrue(rotatedRight[1] == 4.4408920985006262e-16, L"rotate3D");
	Assert::IsTrue(rotatedRight[2] == 5, L"rotate3D");
