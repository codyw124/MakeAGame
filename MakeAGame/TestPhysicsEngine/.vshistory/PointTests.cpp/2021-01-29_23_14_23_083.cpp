...
{
	TEST_CLASS(PointTester)
	{
		TEST_METHOD(T_001_constructor2D)
		{
		...
		TEST_METHOD(T_002_constructorWithValues2D)
		{
			double* values = new double[2];
			values[0] = 5.5;
			values[1] = 7.1;
		...
		TEST_METHOD(T_003_copyConstructor2D)
		{
			double* values = new double[2];
			values[0] = 5.5;
			values[1] = 7.1;
		...
		TEST_METHOD(T_004_moveConstructor2D)
		{
			double* values = new double[2];
			values[0] = 5.0;
			values[1] = 6.0;
		...
		TEST_METHOD(T_005_assignmentOperator2D)
		{
			double* values = new double[2];
			values[0] = 55;
			values[1] = 10;
		...
		TEST_METHOD(T_006_moveAssignmentOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 6;
		...
		TEST_METHOD(T_007_additionOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_008_subtractionOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_009_multiplyOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_010_multiplyByDoubleOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_011_equivalenceOperators2D)
		{
			double* values = new double[2];
			values[0] = 50;
			values[1] = 70;
		...
		TEST_METHOD(T_012_dotProduct2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_014_magnitudeSquared2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_015_divideOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_016_divideByDoubleOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_017_additionShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_018_subtractionShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_019_multiplyShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_020_multiplyByDoubleShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_021_divideShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_022_divideByDoubleShorthandOperator2D)
		{
			double* values = new double[2];
			values[0] = 6;
			values[1] = 10;
		...
		TEST_METHOD(T_024_distanceSquared2D)
		{
			double* values = new double[2];
			values[0] = 5;
			values[1] = 10;
		...
		TEST_METHOD(T_026_normalized2D)
		{
			Point test = Point();
			test.addDimension(0);
		...
		TEST_METHOD(T_028_outputOperator2D)
		{
			Point test = Point();
		...
		TEST_METHOD(T_029_perpendicular2D)
		{
			Point first = Point();
			first.addDimension(5);
			first.addDimension(5);
		...
		TEST_METHOD(T_033_constructor3D)
		{
			Point test;
			test.addDimension(0);
			test.addDimension(0);
		...
		TEST_METHOD(T_034_constructorWithValues3D)
		{
			Point test;
		...
		TEST_METHOD(T_035_copyConstructor3D)
		{
			Point test;
			test.addDimension(5.5);
			test.addDimension(7.1);
		...
		TEST_METHOD(T_036_moveConstructor3D)
		{
			Point test;
			test.addDimension(5);
			test.addDimension(6);
		...
		TEST_METHOD(T_037_assignmentOperator3D)
		{
			Point test;
			test.addDimension(55);
			test.addDimension(10);
		...
		TEST_METHOD(T_038_moveAssignmentOperator3D)
		{
			Point test;
			test.addDimension(5);
			test.addDimension(6);
		...
		TEST_METHOD(T_039_additionOperator3D)
		{
			Point orig;
			orig.addDimension(5);
		...
		TEST_METHOD(T_040_subtractionOperator3D)
		{
			Point orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_041_multiplyOperator3D)
		{
			Point orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_042_multiplyByDoubleOperator3D)
		{
			Point orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_043_equivalenceOperators3D)
		{
			Point test;
		...
		TEST_METHOD(T_044_dotProduct3D)
		{
			Point orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_046_magnitudeSquared3D)
		{
			Point test;
			test.addDimension(5);
			test.addDimension(10);
		...
		TEST_METHOD(T_047_divideOperator3D)
		{
			Point orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_048_divideByDoubleOperator3D)
		{
			Point orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_049_additionShorthandOperator3D)
		{
			Point orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_050_subtractionShorthandOperator3D)
		{
			Point orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_051_multiplyShorthandOperator3D)
		{
			Point orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_052_multiplyByDoubleShorthandOperator3D)
		{
			Point orig;
			orig.addDimension(5);
			orig.addDimension(10);
		...
		TEST_METHOD(T_053_divideShorthandOperator3D)
		{
			Point orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_054_divideByDoubleShorthandOperator3D)
		{
			Point orig;
			orig.addDimension(6);
			orig.addDimension(10);
		...
		TEST_METHOD(T_056_distanceSquared3D)
		{
			Point test;
			test.addDimension(5);
			test.addDimension(10);
		...
		TEST_METHOD(T_058_normalized3D)
		{
			Point test;
			test.addDimension(0);
			test.addDimension(10);
		...
		TEST_METHOD(T_060_outputOperator3D)
		{
			Point test;
			test.addDimension(55);
			test.addDimension(703);
		...
		TEST_METHOD(T_061_perpendicular3D)
		{
			Point first;
			first.addDimension(5);
			first.addDimension(5);
		...
		TEST_METHOD(T_064_crossProduct3D)
		{
			Point right;
		...
		TEST_METHOD(T_065_accessOperator)
		{
			Point test;
			test.addDimension(5);
			test.addDimension(6);
		...
		TEST_METHOD(T_066_getAndAddDimensions)
		{
			Point test;
			test.addDimension(5);
			test.addDimension(6);
		...
		TEST_METHOD(T_067_rotate3D)
		{
			...
			//test z
			Point rotatedRightZ = test.rotate3D(45.0, Point::Z);
			...
			Point rotatedLeftZ = test.rotate3D(-45.0, Point::Z);
			...
			//test x
			Point rotatedRightX = test.rotate3D(45.0, Point::X);
			...
			Point rotatedLeftX = test.rotate3D(-45.0, Point::X);
			...
			//test y
			Point rotatedRightY = test.rotate3D(45.0, Point::Y);
			...
			Point rotatedLeftY = test.rotate3D(-45.0, Point::Y);
		...
		TEST_METHOD(T_068_multiplyMatrix)
		{
			Point a;
			a.addDimension(1);
			a.addDimension(2);
		...
		TEST_METHOD(T_069_multiplyMatrixShorthand)
		{
			Point a;
			a.addDimension(1);
			a.addDimension(2);
