...
void PointTests::destructor()
{
	...
	Assert::IsTrue(test2->getNumberOfDimensions() == 0, L"destructor");
}
...
void PointTests::multiplyOperator3D()
{
	Point orig;
	orig.addDimension(5);
	orig.addDimension(10);
...
void PointTests::multiplyByDoubleOperator3D()
{
	Point orig;
	orig.addDimension(5);
	orig.addDimension(10);
...
void PointTests::divideOperator3D()
{
	Point orig;
	orig.addDimension(6);
	orig.addDimension(10);
...
void PointTests::divideByDoubleOperator3D()
{
	Point orig;
	orig.addDimension(6);
	orig.addDimension(10);
...
void PointTests::multiplyShorthandOperator3D()
{
	Point orig;
	orig.addDimension(5);
	orig.addDimension(10);
...
void PointTests::multiplyByDoubleShorthandOperator3D()
{
	Point orig;
	orig.addDimension(5);
	orig.addDimension(10);
...
void PointTests::divideShorthandOperator3D()
{
	Point orig;
	orig.addDimension(6);
	orig.addDimension(10);
...
void PointTests::divideByDoubleShorthandOperator3D()
{
	Point orig;
	orig.addDimension(6);
	orig.addDimension(10);
...
void PointTests::accessOperator()
{
	Point test;
	test.addDimension(5);
	test.addDimension(6);
...
void PointTests::getAndAddDimensions()
{
	Point test;
	test.addDimension(5);
	test.addDimension(6);
