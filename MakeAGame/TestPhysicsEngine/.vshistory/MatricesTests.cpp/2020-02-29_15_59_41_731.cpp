...
void MatricesTests::transpose()
{
	...
	//make sure they are in the matrix
	Assert::IsTrue(0.0 == a[0][0], L"transpose"); Assert::IsTrue(1.0 == a[0][1], "transpose"); Assert::IsTrue(2.0 == a[0][2], "transpose");
	Assert::IsTrue(3.0 == a[1][0], L"transpose"); Assert::IsTrue(4.0 == a[1][1], "transpose"); Assert::IsTrue(5.0 == a[1][2], "transpose");
	Assert::IsTrue(6.0 == a[2][0], L"transpose"); Assert::IsTrue(7.0 == a[2][1], "transpose"); Assert::IsTrue(8.0 == a[2][2], "transpose");

	//transpose it
	a.transpose();

	//make sure they are transposed
	Assert::IsTrue(0.0 == a[0][0], L"transpose"); Assert::IsTrue(3.0 == a[0][1], "transpose"); Assert::IsTrue(6.0 == a[0][2], "transpose");
	Assert::IsTrue(1.0 == a[1][0], L"transpose"); Assert::IsTrue(4.0 == a[1][1], "transpose"); Assert::IsTrue(7.0 == a[1][2], "transpose");
	Assert::IsTrue(2.0 == a[2][0], L"transpose"); Assert::IsTrue(5.0 == a[2][1], "transpose"); Assert::IsTrue(8.0 == a[2][2], "transpose");
}
